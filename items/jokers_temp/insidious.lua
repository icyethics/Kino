SMODS.Joker {
    ...
    locked_loc_vars = function(self, info_queue, card)
        return {
            vars = {
                G.PROFILES[G.SETTINGS.profile].consumeable_usage and G.PROFILES[G.SETTINGS.profile].consumeable_usage.c_kino_demon and G.PROFILES[G.SETTINGS.profile].consumeable_usage.c_kino_demon.count or 0,
                5
            }
        }
    end,
    check_for_unlock = function(self, args)
        ...
        G.PROFILES[G.SETTINGS.profile].consumeable_usage and G.PROFILES[G.SETTINGS.profile].consumeable_usage.c_kino_demon and G.PROFILES[G.SETTINGS.profile].consumeable_usage.c_kino_demon.count >= 5 then
            unlock_card(self)
        end
    end,
}