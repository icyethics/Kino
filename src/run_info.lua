...
-- Version with premade option toggle
-- function create_UIBox_quest_log(simple)
...
-- 	local _questjokers_ui_elements = {}
-- 	local questjokerpages = {}
-- 	local questjokerpagenames = {}
-- 	local questjokers_per_page = 4
-- 	local _questjokersbyorder

-- 	-- Gather all questjokers

-- 	for i = 1, #Kino.legendaries do
...
-- 	-- Generate each page
-- 	local _number_of_pages = math.ceil(#Kino.legendaries / 2)

-- 	for i = 1, _number_of_pages do
-- 		local _questjokerpage_object = {}

-- 		for j = 1, #_questjokers_ui_elements do
-- 			if _questjokers_ui_elements[(-4 + (i * 4)) + j] then
-- 				_questjokerpage_object[j] = _questjokers_ui_elements[(-4 + (i * 4)) + j]
-- 			end
-- 		end

-- 		-- questjokerpages[#questjokerpages + 1] = _questjokerpage_object
-- 		questjokerpages[#questjokerpages + 1] = {
-- 													n=G.UIT.R, 
-- 													config = {
-- 														align = "cm",
-- 														colour = G.C.CLEAR
-- 													}, 
-- 													nodes = _questjokerpage_object
-- 												}
-- 		questjokerpagenames[#questjokerpagenames + 1] = localize("k_legendaryquest_page") .. ' ' .. tostring(i) .. '/' .. tostring(math.ceil(#Kino.legendaries / 2))
-- 	end


-- 	-- Options
-- 	local optioncycle = create_UIBox_generic_options(
-- 		{ 
